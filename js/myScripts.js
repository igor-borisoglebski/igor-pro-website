...
function adjustStickyTitleTop() {
  console.log("Adjusting Stikcy Topic Top");
  var topnav = document.getElementById("topnav");
  console.log("topnav.height=" + topnav.height);
  var topnav_height = topnav.height;
  document.getElementsByClassName("stickytitle").style["top"] = topnav_height;
}
